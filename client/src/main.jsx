...
import AdminFeatured  from "./pages/admin/AdminFeatured"; // ✅ notun
    ...
    children: [
      ...
      // Admin pages (admin role lagbe)
      {
        ...
        children: [
          ...
          { path: "featured",  element: <AdminFeatured /> }, // ✅ notun
        ],
      },
    ],
  },
